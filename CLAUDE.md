...
> 权威：与 `skills/prism-os/CLAUDE.md` 内容相同；流程规范以 `skills/prism-os/SKILL.md` 为准
...
完整位置 + 修复建议见 `skills/prism-os/SKILL.md` § 已知代码缺口。

---

## ✅ 必须遵守的 3 件事

1. **走 run**：所有 PRISM-OS 内容生成走 `python prism_os.py run "<命题>"`
...
- 流程规范：`skills/prism-os/SKILL.md`（事实源，450-500 行）
- 实操手册：`skills/prism-os/MANUAL.md`（命令示例、UI 文本、FAQ）
